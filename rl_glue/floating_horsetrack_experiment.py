...
import floating_horsetrack_environment
from rl_glue import RLGlue  # Required for RL-Glue
import random_agent
from sarsa_func import SARSA
...
def main(agent_info, agent_class, steps, filename):
    env_class = floating_horsetrack_environment.HorsetrackEnvironment
    ...
    save_results(episode_end, len(episode_end), filename)
...
if __name__ == "__main__":
    ...
    agents = {1: random_agent.RandomAgent,
              2: SARSA}
